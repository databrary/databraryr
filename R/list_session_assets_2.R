...
#' 
#' `list_session_assets_2()` may eventually replace  `list_session_assets()` as
#' the new function does not require a volume id.
#'
...
#' }
#' @export
list_session_assets_2 <- function(session_id = 9807,
                                  vb = FALSE,
                                  rq = NULL) {
