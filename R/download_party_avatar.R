...
#' }
#' # Download avatars from Databrary's founders but do not show their names
#' and affiliations.
#' download_party_avatar(5:7, show_person_info = FALSE)
#' @export
download_party_avatar <- function(party_id = 6,
  ...
  if (vb) message("Retrieving avatars for parties: ", min(party_id), ":", max(party_id))
