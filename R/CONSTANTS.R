...
# API_CONSTANTS <- "https://api.databrary.org/constants"
# 
# CREATE_SLOT <-
...
DATABRARY_API <- "https://api.databrary.org/api"
# DOWNLOAD_FILE <-
...
GET_SESSION_BY_ID = "https://api.databrary.org/volumes/%s/sessions/%s"
# GET_ACTIVITY_DATA <-
#   "https://nyu.databrary.org/api/activity"
GET_PARTY_BY_ID <- 
  "https://api.databrary.org/users/%s"
GET_PARTY_NO_PARENTS_CHILDREN <- "https://api.databrary.org/users/%s"
# GET_CONSTANTS <- "https://api.databrary.org/constants"
