...
```{r login}
login_db(email = "rogilmore@psu.edu")
```

If everything works out, you should see a `Login successful` message at the R console.
Congratulations, you are ready to access Databrary's shared information along with any private, unshared information you have access to.

## First steps

Let's make sure that everything is working.
Try this command to pull data about Databrary's founders:
