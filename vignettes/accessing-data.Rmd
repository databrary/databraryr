...
The `magrittr` package pipe ('%>%') also works.
...
The following set of commands downloads all of the 'csv' files in the volume.
It creates a new directory based on the session/slot ID (9807).
