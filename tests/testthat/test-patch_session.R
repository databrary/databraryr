...
test_that("patch_session returns NULL when no fields provided", {
  expect_null(patch_session(vol_id = 1777, session_id = 1, vb = FALSE))
})
...
test_that("patch_session rejects invalid name", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = ""))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "   "))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = 123))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = c("A", "B")))
})
...
test_that("patch_session rejects malformed source_date", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, source_date = "not-a-date"))
  expect_error(patch_session(vol_id = 1777, session_id = 1, source_date = ""))
  expect_error(patch_session(vol_id = 1777, session_id = 1, source_date = 123))
})

test_that("patch_session rejects malformed date", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, date = "2024-03-15"))
  expect_error(patch_session(vol_id = 1777, session_id = 1, date = list(2024, 3, 15)))
})

test_that("patch_session rejects invalid release_level", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, release_level = ""))
  expect_error(patch_session(vol_id = 1777, session_id = 1, release_level = 1))
  expect_error(patch_session(vol_id = 1777, session_id = 1, release_level = c("A", "B")))
})

test_that("patch_session rejects invalid date_precision", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, date_precision = ""))
  expect_error(patch_session(vol_id = 1777, session_id = 1, date_precision = 1))
})

test_that("patch_session rejects invalid default_records", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, default_records = "1"))
  expect_error(patch_session(vol_id = 1777, session_id = 1, default_records = c(1, -2)))
  expect_error(patch_session(vol_id = 1777, session_id = 1, default_records = c(1, 0)))
  expect_error(patch_session(vol_id = 1777, session_id = 1, default_records = c(1.5, 2)))
  expect_error(patch_session(vol_id = 1777, session_id = 1, default_records = integer(0)))
})
...
test_that("patch_session rejects invalid session_id", {
  expect_error(patch_session(vol_id = 1777, session_id = -1, name = "x"))
  expect_error(patch_session(vol_id = 1777, session_id = 0, name = "x"))
  expect_error(patch_session(vol_id = 1777, session_id = "1", name = "x"))
  expect_error(patch_session(vol_id = 1777, session_id = TRUE, name = "x"))
  expect_error(patch_session(vol_id = 1777, session_id = c(1, 2), name = "x"))
  expect_error(patch_session(vol_id = 1777, session_id = 1.5, name = "x"))
})

test_that("patch_session rejects invalid vb parameter", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", vb = -1))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", vb = "a"))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", vb = c(TRUE, FALSE)))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", vb = NULL))
})

test_that("patch_session rejects invalid rq parameter", {
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", rq = "a"))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", rq = -1))
  expect_error(patch_session(vol_id = 1777, session_id = 1, name = "x", rq = TRUE))
})
