...
test_that("list_authorized_investigators returns a data.frame or is NULL.",
          {
            expect_true((
              is.null(list_authorized_investigators()) ||
...
test_that("list_authorized_investigators rejects bad input parameters", {
  ...
  expect_error(list_authorized_investigators(party_id = list(a = 1, b =
                                                               2)))
...
test_that(
  "list_authorized_investigators returns NULL for invalid (non-institutional) party IDs",
  {
