...
test_that("unassign_record_from_file rejects invalid vol_id", {
  ...
  expect_error(unassign_record_from_file(vol_id = 1.5, session_id = 1, file_id = 1, record_id = 1))
})

test_that("unassign_record_from_file rejects invalid session_id", {
  expect_error(unassign_record_from_file(vol_id = 1, session_id = -1, file_id = 1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 0, file_id = 1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = "1", file_id = 1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = TRUE, file_id = 1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = c(1, 2), file_id = 1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1.5, file_id = 1, record_id = 1))
})

test_that("unassign_record_from_file rejects invalid file_id", {
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = -1, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 0, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = "1", record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = TRUE, record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = c(1, 2), record_id = 1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1.5, record_id = 1))
})

test_that("unassign_record_from_file rejects invalid record_id", {
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = -1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 0))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = "1"))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = TRUE))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = c(1, 2)))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1.5))
})

test_that("unassign_record_from_file rejects invalid vb parameter", {
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, vb = -1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, vb = 3))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, vb = "a"))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, vb = c(TRUE, FALSE)))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, vb = NULL))
})

test_that("unassign_record_from_file rejects invalid rq parameter", {
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, rq = "a"))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, rq = -1))
  expect_error(unassign_record_from_file(vol_id = 1, session_id = 1, file_id = 1, record_id = 1, rq = TRUE))
})
